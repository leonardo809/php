...
echo '<script src="nav.js"><script src="./bootstrap.min.js"></script>
<link rel="stylesheet" href="./bootstrap.min.css"></script><mi-nav></mi-nav>';
...
$conexionC = mysqli_connect($hostname_localhost,$username_localhost,$password_localhost,$database_localhost);
	...
	$consultaC="select * from cargo order by idasiento;";
		...
		echo  '<script type="module" src="footer.js"></script>';
